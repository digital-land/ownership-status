# Brownfield Ownership Status pages
...
These pages are [updated nightly](https://github.com/digital-land/brownfield-ownership-status/actions) by the [GitHub Action](.github/workflows/run.yml).
